...
//                     Город: {selectedCity}
//                     {dropdownOpen && (
//                         <div className="absolute top-12 right-0 bg-white border rounded-lg shadow-lg w-62 max-h-96 overflow-y-auto z-10000">
//                             {cities.map((city) => (
//                                 <div
//                                     key={city.id}
...
//                             }`}
//                         >
//                             <div className="text-lg font-medium text-gray-600">{prayerNames[prayerName as keyof PrayerTimes]}</div>
//                             <div className="text-4xl font-bold text-gray-800">{time}</div>
//                             {nearestPrayer === prayerName && (
//                                 <>
//                                     <div className="absolute top-2 right-2 bg-transparent text-sm font-medium p-2 rounded-lg">
...
//                                             style={{
//                                                 width: `${(remainingTime / calculateTimeDifference(time)) * 100}%`,
//                                             }}
//                                         />
//                                     </div>
//                                 </>
